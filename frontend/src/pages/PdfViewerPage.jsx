    ...
    >
      ...
      <div className="flex-1 p-3 sm:p-4 lg:p-6 max-w-7xl mx-auto w-full flex flex-col items-center overflow-hidden">
        ...
        >
          ...
          {/* PERMANENT FLOATING CONTROL TOOLBAR AT THE BOTTOM OF THE VIEWER (STRICT SINGLE HORIZONTAL LINE & FIXED SCREEN POSITION) */}
          {pdfDoc && !loading && (
            <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 bg-dark-surface/95 backdrop-blur-md border border-dark-border text-white px-3 sm:px-4 py-2 rounded-2xl shadow-2xl flex items-center gap-2 sm:gap-3 flex-nowrap whitespace-nowrap overflow-x-auto no-scrollbar max-w-[96vw] sm:max-w-fit justify-center animate-fadeIn">
